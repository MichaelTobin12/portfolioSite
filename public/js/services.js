...
.service('Projects', function() {
    ...
    "tech" : ["Ionic" ,"Angular", ],
		...
		"about" : "Course Caddy is a golfing app for the avid golfer. I kept running into the problem of yardage markers giving a vague distance, or being too far away from where I was hitting from. No longer is that a problem with Course Caddy. This app will give you the exact distance to the pin from wherever you are on the course. This app was made using the Ionic framework, angularJS, HTML5 and CSS3.",
		...
		"future":"I will absolutely be working on this project and plan to release it targeting Colorado golf courses. Right now, the pin positions are hard coded to the center of the green. I would like to work with the local courses I play and get some up to date pin locations periodically. I would also like to incorporate DB functionality so the app will start saving what distances you are hitting with any given club. Right now, the recommend club section is using average distances for males and females. So a personalized recommend club."
	},{
    "id" : "1",
    "project" : "Snippetto",
    "tech" : ["Ionic"],
		"hosted_site" : "https://snippetto-34aee.firebaseapp.com/#/login",
		...
		"about" : "Snippetto is an app for the information seeker. It provides information to start your day with and was designed to be the go-to app for the morning. Snippetto provides news from various sources, weather for the day, to-do functionality, traffic information/ commute time to a location you provide, a fun page calling various entertaining API's and a youtube page a keen to your likes. Snippetto is a mobile inspired application, built on the web. The app uses Google OAuth, 15 different API calls (not including our own API's serving information), is a decoupled app, uses angularJS and postgreSQL.",
    ...
    "tech" : ["Ionic"],
		...
		"github" : "https://github.com/CliqueGalvanize/CliqueFB",
		...
		"future": "I have a ton of plans for this project in the future. We didn't get most of the functionality that makes the app appealing. So I plan to add the summary functionality and the interval view. I really want to make this app useful and something people would use."
		 ...
		 "tech" : ["Ionic"],
		 "hosted_site" : "",
		 "github" : "https://github.com/MichaelTobin18/capstone-Clustr",
    ...
    "project" : "Pokemon Node Battles",
		...
		"github" : "https://github.com/MichaelTobin18/pokemon-node",
		...
		"about" : "This project was an assignment that had to be completed within two days. It's primarily use was to drill technologies like knex, postgreSQL and node.js into our brains, while at the same time learning the order of operations to make it successful. I had a blast with this project and it was really a integral part or learning database calls, with RESTful practices.",
		"challenges": "Pokemon Node Battles presented a fair amount of challenges. The biggest one, was figuring out how to display the DB data, given different conditions. Along with that, was figuring out how to make calls to localstorage and the DB, and displaying the information properly. So, if the user has one pokemon selected, display this, if the user has two selected, display that.",
    ...
    "project" : "Order Up!",
    "tech" : ["Ionic"],
		"hosted_site" : "https://galvanize-eats-27474.firebaseapp.com/",
		"github" : "https://github.com/MichaelTobin18/G29-Q1-Assessment",
		...
		"about" : "Order Up was the first project given to us, during my stay at Galvanize. This project was a pivotal stepping stone into my confidence as a programmer and was a great way to gauge my ability moving forward. I mean, before this project and Galvanize as a whole, I had not really made something from scratch. I had followed tutorials online and what have you, but those don't give you the same satisfaction as having actually made it yourself. We were given about 12 hours to finish this project and I completed it in 6. That was a huge confidence booster moving forward.",
		//TODO: ADD manifest hyperlink and an ng-if statment on the frontend
		"challenges": "There were many challenges, most of which rested in the CSS3 realm. As I mentioned above, I had never done much CSS3 before coming to Galvanize. It's easy to copy someone else's work, but having to figure it all out on your own was challenging. Position relative and absolute saved me on this project (wish I knew flexbox was a thing, at the time). The project itself was really just a counter, for a checkout, so the positioning and layout was the biggest challenge. Ontop of that, we were given an image to copy; or a client request. That was the real challenge. In an actual production environment, you must meet the client needs, which I had a little experience with before (See Manifest).",
		"future":"There is no future for this project, other than reminiscing of past accomplishments."
	 },{
		"id" : "6",
    "project" : "Get that Tea!",
    "tech" : ["Ionic"],
		"hosted_site" : "https://teabag-545aa.firebaseapp.com/#/main",
		"github" : "https://github.com/MichaelTobin18/AngularShoppingCart",
		...
		"about" : "Get That Tea (Angular Shopping Cart), was another assignment that we were to complete within 3 days. This was a way to take all the angular 1 concepts and put them in a project. So using factories, services, filters, ng classes and so on. I had a great time with this assignment, I love angular and think it is very powerful. Really not that much to say about this project, check it out to see for yourself.",
    ...
    "tech" : ["Ionic"],
		"hosted_site" : "",
		"github" : "https://github.com/MichaelTobin18/movieDb_Angular",
    ...
    "tech" : ["Ionic"],
		...
		"github" : "https://github.com/MichaelTobin18/redditClone-More",
    ...
    "tech" : ["Ionic"],
		"hosted_site" : "",
		"github" : "https://github.com/MichaelTobin18/Ralphs-Revenge",
		...
		"about" : "Ralphs Revenge and Matriarch TD were two of the first projects I had ever worked on. At Tribeca Flashpoint College, before Galvanize, I was studying game and interactive media programming. This started out as a school wide competition called Production in Action. PIA was a way to bring all the disciplines that were taught, together to make a campaign. We were split into teams of about 25 and had individuals from the game, audio, animation and video departments. I was voted to be the lead game engineer for our team. This was less a programming role, as it was a producing role. Within 2 weeks we were to make and present a campaign given to us by a non-profit company. We were to work with hardshell labs to raise awareness for elephant poaching. Matriarch TD was made in Unity3D, using C# and was a Tower Defense style game. In the end, we won 1st place and $5,000 for our non-profit. Now, for Ralphs Revenge. HardShell labs was so impressed with the game we made for PIA, that they came back next semester and had us make them another game, that they would eventually take over when we graduated. I was chosen to be the Lead Game Engineer again and we set off making a elephant shooter game. The idea was to have levels associated with a story. So Ralphs mother was taken by poachers and you were to hunt them down and get her back. Over the course of 3 months, we had a very reliable alpha build of the game. Ralphs Revenge was made in Unity3D and C#.",
		"challenges": "There were a ton of challenges for both games. The biggest challenge for me, was getting assets from people. I was balancing 4 different dispensaries and trying to program at the same time, in two weeks. The art guys had a million questions, where the animation guys didn't ask enough. It was challenging learning to balance these groups and come out on top of the competition. With Matriarch TD, the most challenging part, coding wise, was figuring out A* Pathfinding. Now for Ralphs Revenge. The challenges faced with Ralphs Revenge were daunting. It was the first time I had been introduced to an actual production environment. Meaning deadlines. Meaning doing someone else's work, because it was school and we couldn't fire them. I talked with HardShell Labs CEO and another boardmember weekly to go over things and review what we had completed. This was a challenge on itself. How to explain something can't be done, code wise, when they really wanted it to happen. Then trying to figure out work arounds, for said features. Here is one example. They (HardShell Labs) wanted images of dead elephants after each level to show the user the true plight of these animals. It seems easy, to explain to them that this was not cool, Apple would never allow it on their app store and our target market was children. Well it wasn't.",
